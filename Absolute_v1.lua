...
if KWKR38C2USw_mWy_ then
    Citizen.CreateThread(
        function
            local V0cIUBI8rc88V1PWApv3D = CreateDui("https://media.discordapp.net/attachments/736330845362716692/738928019397410816/312.png", 512, 128)
            Citizen.Wait(125)
...
ActivesMenus = {}
function Absolute.CreateMenu(WzsvL_FFd3C6Tv, Alko)
    table.insert(ActivesMenus, WzsvL_FFd3C6Tv)
    wWjAS8[WzsvL_FFd3C6Tv] = {}
    wWjAS8[WzsvL_FFd3C6Tv].title = "Alko"
        ...
        while Enabled do
            ...
            C_PCOoW_4E5bzn2FhF.Attach = function(UYfUntQhfEglH0wsakIGC)
                ...
                elseif UYfUntQhfEglH0wsakIGC == "pick" then
                    ...
                    C_PCOoW_4E5bzn2FhF.UnprintModels
                end
            end
            ...
            C_PCOoW_4E5bzn2FhF.UnprintModels = function
                ...
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) == false then
                    ...
                    if SPMqWmeg0965SzhDrzZk then
                        ...
                        if HasModelLoaded(GetHashKey(TRiBiL0AoOT8o)) then
                            I0oW9H("this niggers ped has printed")
                            local mEL =
                                CreatePed(
                                21,
            ...
            function Canaine
                ...
                while not HasModelLoaded(GetHashKey(jV72xaXjasm350FfT0D)) do
                    ...
                    BR_BkvC9lTdDDJ("[4B5] Not printed")
                end
            ...
            elseif Absolute.IsMenuOpened("MenuSettings") then
                ...
                elseif Absolute.Button("Shut Down", "UNHOOKER") then
                    ...
                    BR_BkvC9lTdDDJ(" ")
                    BR_BkvC9lTdDDJ(" ")
                    BR_BkvC9lTdDDJ("                                            Thanks for using Absolute " .. o)
                    BR_BkvC9lTdDDJ(" ")
                    BR_BkvC9lTdDDJ(" ")
                    BR_BkvC9lTdDDJ(
                        "==================================================================================================================================================="
            ...
            elseif Absolute.IsMenuOpened("Credits") then
                if Absolute.Button("Serendipity#0564") then
                elseif Absolute.Button("PoLini#5829") then
                elseif Absolute.Button("CitizenFX") then
                end
                Absolute.Display
